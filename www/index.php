      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
                 ...
                 <?php
					$articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = '2' ORDER BY `id` DESC LIMIT 4");
			...
			<?php
					$articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = '3' ORDER BY `id` DESC LIMIT 4");
